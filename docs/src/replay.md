...
- **GitHub's secondary rate limit,** which refuses bursts with a 403 or 429 however much of the hourly budget is left, is waited out: up to three retries, after one, two and three minutes. Any other refusal stops the fetch.
